         ...
         (begin
           ...
           (define rtd
             (if (rtd? parent)
                 ...
                 (error "define-record-type: parent is not a record type" parent)))
           (define name rtd)
         ...
         (bound-identifier=?
          ...
          (begin
            ...
            (define-record-type/accessors+mutators
              ...
              (more ...)
              (n . checked)))
          (syntax-error "field tags must be the same in the constructor as in the field specs" 'field-tag1 'field-tag2)))
        ((_ rtd pred
